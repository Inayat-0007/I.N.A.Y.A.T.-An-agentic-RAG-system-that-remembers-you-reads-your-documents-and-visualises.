    ...
    <div className="relative min-h-[90vh] flex flex-col items-center justify-center py-12 px-6">
      ...
      <div className="relative z-10 max-w-4xl w-full text-center flex flex-col items-center mt-8">
        ...
        >
          ...
          <span className="text-white font-medium border-b border-cyber-cyan/40">
            remembers you
          </span>
          , reads your{" "}
          <span className="text-white font-medium border-b border-cyber-cyan/40 font-heading">
            documents
          </span>
          , and visualises its{" "}
          <span className="text-white font-medium border-b border-cyber-magenta/40">
            knowledge graph
          </span>{" "}
          in real time.
        </motion.p>
        ...
        >
          ...
          <h3 className="text-sm font-subheading font-bold text-cyber-text mb-4 uppercase tracking-widest text-center flex items-center justify-center gap-2">
            <Sparkles className="w-4 h-4 text-cyber-cyan" /> Initialize Demo
            Workspace
          </h3>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            />
            {errorMsg && (
              <p className="text-xs text-cyber-magenta font-semibold mt-1">
                ⚠️ {errorMsg}
              </p>
            )}
            ...
            >
              Access Agentic Workspace{" "}
              <ArrowRight className="w-4 h-4 text-cyber-bg transition-transform duration-200 group-hover:translate-x-1" />
            </button>
          </form>
        </motion.div>
        ...
        >
          ...
          <div className="flex flex-col items-center p-3 rounded-xl bg-white/[0.02] border border-cyber-border/20">
            <div className="flex items-center gap-1">
              ...
              <span className="font-heading font-extrabold text-2xl text-purple-400">
                3 Cloud
              </span>
            </div>
            <span className="text-xs text-cyber-muted font-subheading mt-1">
          ...
          <div className="flex flex-col items-center p-3 rounded-xl bg-white/[0.02] border border-cyber-border/20">
            <div className="flex items-center gap-1">
              ...
              <span className="font-heading font-extrabold text-2xl text-cyber-magenta text-glow-magenta">
                Active
              </span>
            </div>
            <span className="text-xs text-cyber-muted font-subheading mt-1">
          ...
          <div className="flex flex-col items-center p-3 rounded-xl bg-white/[0.02] border border-cyber-border/20">
            <div className="flex items-center gap-1">
              ...
              <span className="font-heading font-extrabold text-2xl text-cyber-gold">
                Isolated
              </span>
            </div>
            <span className="text-xs text-cyber-muted font-subheading mt-1">
