...
export default function FeaturesShowcase() {
  const features = [
    ...
    },
    {
      ...
      desc: "Backed by 44 smoke tests plus 10 live integration tests; CI runs smoke and frontend build on every PR.",
    },
  ];
    ...
    <section className="py-20 px-6 max-w-6xl mx-auto border-t border-cyber-border/40 relative">
      <div className="text-center mb-16">
        ...
        <p className="text-sm font-subheading text-cyber-muted max-w-xl mx-auto font-light">
          A high-performance feature set designed to deliver robust,
          uninterrupted RAG execution.
        </p>
      </div>
